...
public class ViewCustomerDetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_view_customer_detail);
            ...
            public void onClick(View view) {
                ...
                btnUpdate.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        validUtils.showProgressDialog(ViewCustomerDetailActivity.this, ViewCustomerDetailActivity.this);
                        StringRequest request = new StringRequest(Request.Method.POST, EDIT_CUSTOMER_URL,
                                    ...
                                    public void onResponse(String response) {
                                        ...
                                        try {
                                            ...
                                            if (jsonObject.getString("status")
                                                ...
                                                startActivity(new Intent(ViewCustomerDetailActivity.this, ListCustomerActivity.class));
                                                Bungee.split(ViewCustomerDetailActivity.this);
                                                validUtils.showToast(ViewCustomerDetailActivity.this,jsonObject.getString("message"));
                                                ...
                                                validUtils.hideProgressDialog();
                                                validUtils.showToast(ViewCustomerDetailActivity.this,"Something went Wrong");
                                            }

                                        } catch (JSONException e) {
                                            e.printStackTrace();
                                            validUtils.hideProgressDialog();
                                            validUtils.showToast(ViewCustomerDetailActivity.this,e.getMessage());
                                        }
                                ...
                                new Response.ErrorListener() {
                                    ...
                                    public void onErrorResponse(VolleyError error) {
                                        validUtils.hideProgressDialog();
                                        validUtils.showToast(ViewCustomerDetailActivity.this,error.getMessage());
                                    }
                                })
                        {
                        ...
                        RequestQueue queue = Volley.newRequestQueue(ViewCustomerDetailActivity.this);
                        queue.add(request);
